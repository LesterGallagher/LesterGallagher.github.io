(function() {
  ...
  if (techStackSvg !== null) initD3TechStackBubble();

  function initD3TechStackBubble() {
    d3.json("https://bunkersem.github.io/portfolio/technologies.json", initD3TechStackBubbleWithData);
  };
