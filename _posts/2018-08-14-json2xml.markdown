...
As it turns out, finding a good xml to json javascript library is not as easy as it sounds. I did find (https://davidwalsh.name/convert-xml-json)[this] implementation does the job but sometimes the output can be a bit confusing:
